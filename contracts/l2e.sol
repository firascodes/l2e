...
//sepolia contract address : 0xC13B3E6390e47a6a1C37114CcE49091bf65A05BC
//goerli contract address : 0x1D4E8e58bcCFaFC3ddEA7d995527C6Cf855465B6
...
contract Learn2Earn{
    ...
    // set isForSale to true and set pricePerShare maximum of 25% more than original pricePerShare
    function sellCourse(uint256 _courseId, uint256 _pricePerShare) public{
        ...
        require(_pricePerShare <= students[msg.sender].pricePerShare * 250 / 100, "Price per share cannot be more than 10% of original price per share");
    ...
    function buyCourseFromStudent(address _studentAddress, uint256 _courseId, uint256 _shares) public payable {
        ...
        students[msg.sender].isForSale = false;
        students[msg.sender].pricePerShare = students[_studentAddress].pricePerShare;
